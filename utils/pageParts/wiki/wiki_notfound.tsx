        ...
        <>
            ...
            <main style={{ padding: '2rem', textAlign: 'center', fontFamily: 'sans-serif' }}>
                <div className="article text-center">
                    <h1>404 Not Found</h1>
                    <div className="noticeWikiRemoval" role='alert'>
                    ...
                    <div className="noticeWikiRemovalRelated">
                        <span className="noticeWikiRemoval__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                    ...
                    <svg className="noticeWikiRemoval__overlayIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
