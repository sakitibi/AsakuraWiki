...
export default function Fold({ title, initiallyOpen, children }: {
    ...
    const [open, setaOpen] = useState(initiallyOpen)
    const iconPath = open
    ...
    return(
        <div style={{ margin: '8px 0' }}>
            <button onClick={() => setOpen(!open)} type="button" style={{backgroundColor: 'initial', border: 'none', color: 'inherit', cursor: 'pointer', display: 'block', float: 'left', fontSize: '22px', lineHeight: '1em', margin: '-1px 0', padding: '0'}}>
