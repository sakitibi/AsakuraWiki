                                        ...
                                        {userData.map((data, index) => {
                                            ...
                                            return (
                                                <div key={index}>
                                                    ...
                                                    <p>email: {
                                                        settings.type
                                                            ? decodeBase64Unicode(deobfuscate(data.metadatas[0], settings.key, settings.charset))
                                                            : decodeBase64Unicode(obfuscate(data.metadatas[0], settings.key, settings.charset))
                                                    }</p>
                                                    <p>password: {
