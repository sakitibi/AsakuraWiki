                ...
                <div className={styles.contents}>
                    ...
                    <main style={{ padding: '2rem', flex: 1 }}>
                        ...
                        <div className="p-entry__content">
                            ...
                            <p>広告を掲載できることにより、 広告を掲載した方のビジネス戦略を確保しています。<br/>また、コンテンツ品質の向上や安定してWikiを運営するために<br/>広告の掲載を一部制限しています。(10カ月以上安定して運営しています。)</p>
                            ...
                            <div className={styles.panelBody}>
                                <div style={{ display: 'flex' }}>
                                    ...
                                    <div style={{ minWidth: '200px' }}>
                                        <p>当サービスで得られた広告収益の一部は、名前は長い方が有利批判と<a href="/special_wiki/maitetsu_bkmt">マイ鉄ネット撲滅委員会</a>の活動の費用として適切に使用しております。<br/>広告収益を通じて、皆さまのご利用が名前は長い方が有利&amp;マイ鉄ネット批判への貢献につながっていることをお伝えできれば幸いです。<br/></p>
