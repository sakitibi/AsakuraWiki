                    ...
                    <main style={{ padding: '2rem', flex: 1 }}>
                        ...
                        <div className="pEntry__content">
                            ...
                            <div className={styles.listGroup}>
                                ...
                                <a className={styles.listGroupItem} href="#02">WIKIの管理人に収益が発生しますか？</a>
                                <a className={styles.listGroupItem} href="#03">WIKIの管理人に収益が発生しますか？</a>
                                <a className={styles.listGroupItem} href="#04">WIKIの管理人に収益が発生しますか？</a>
                                <a className={styles.listGroupItem} href="#05">WIKIの管理人に収益が発生しますか？</a>
                            </div>
                            ...
                            <p>広告を掲載できることにより、 広告を掲載した方のビジネス戦略を確保しています。<br/>また、コンテンツ品質の向上や安定してWikiを運営するために<br/>広告の掲載を一部制限しています。(3カ月以上安定して運営しています。)</p>
                        ...
                        <div className={`${styles.panel} ${styles.panelSuccess}`} style={{ marginTop: '30px'}}>
                            <div className={styles.panelHeading}>
                                <i className={`${styles.faSolid} ${styles.faLandmark} ${styles.faFw} ${styles.faLg}`}>
                                    広告収益の社会貢献について
                                </i>
                            </div>
                            <div className={styles.panelBody}>
                                <div style={{ display: 'flex' }}>
                                    ...
                                    <div style={{ minWidth: '200px' }}>
                                        <p>当サービスで得られた広告収益の一部は、名前は長い方が有利批判と<a href="/special_wiki/maitetsu_bkmt">マイ鉄ネット撲滅委員会</a>の費用として適切に使用しております。<br/>広告収益を通じて、皆さまのご利用が名前は長い方が有利&amp;マイ鉄ネット撲滅批判への貢献につながっていることをお伝えできれば幸いです。<br/></p>
