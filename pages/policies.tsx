                    ...
                    <main style={{ padding: '2rem', flex: 1 }}>
                        ...
                        <div className="p-entry__content">
                            ...
                            <ol>
                                ...
                                <li>本規約の内容と、その他の本規約外における他サービス利用規約、条例、法律、憲法などと衝突する場合は、<br/><strong>本規約の規定が優先して適用されるもの</strong>とします。(14nin利用規約引用)</li>
                            ...
                            <ol>
                                <li>当社は、以下のいずれかに該当する場合には、登録ユーザーに事前に通知することなく、本サービスの全部または一部の提供を停止または中断することができるものとします。
                                    <ol>
                                        ...
                                        <li>地震、落雷、火災、風水害、停電、天災地変、サイバー攻撃などの不可抗力により本サービスの運営ができなくなった場合</li>
                            ...
                            <ol>
                                ...
                                <li>ユーザーは、投稿データについて、当社に対し、世界的、非独占的、無償、サブライセンス可能かつ譲渡可能な使用、複製、配布、派生著作物の作成、表示及び実行、商用利用に関するライセンスを付与します。また、当社が利用許諾する第三者に対しても、本サービスを利用してユーザーが投稿その他送信した投稿データの使用、複製、配布、派生著作物を作成、表示及び実行することについての非独占的なライセンスを付与します。</li>
                            ...
                            <h2>第15条（本規約等の変更）</h2>
                            <p>当社は、法務委員会委員長を通じて本規約を変更できるものとします。当社は、本規約を変更した場合には、登録ユーザーに当該変更内容を通知するものとし、当該変更内容の通知後、登録ユーザーが本サービスを利用した場合または当社の定める期間内に登録抹消の手続をとらなかった場合には、登録ユーザーは、本規約の変更に同意したものとみなします。</p>
                            <h2>第16条（連絡／通知）</h2>
