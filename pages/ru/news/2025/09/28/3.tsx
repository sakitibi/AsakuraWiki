            ...
            <div className={styles.contentsWrapper}>
                ...
                <div className={styles.contents}>
                    ...
                    <main style={{ padding: '2rem', flex: 1 }}>
                        ...
                        <ol>
                            <li>Празднование дня рождения участника Asakura Рин Саэгусы! (Специальная страница)</li>
                            <li>Четыре года со дня взрыва дома Сэнсэя Агеру-куна,<br/> поминальная служба (на специальной странице)</li>
                        </ol>
