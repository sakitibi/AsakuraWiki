                ...
                <div className={styles.contents}>
                    ...
                    <main style={{ padding: '2rem', flex: 1 }}>
                        ...
                        <div className="p-entry__content">
                            ...
                            <p>Имея возможность размещать рекламу, мы обеспечиваем бизнес-стратегию человека, разместившего объявление.<br/>Кроме того, некоторые рекламные объявления ограничены с целью<br/>улучшения качества контента и стабильной работы вики. (Мы стабильно работаем уже более 7 месяцев.)</p>
