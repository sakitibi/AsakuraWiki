                ...
                <div className={styles.contents}>
                    ...
                    <main style={{ padding: '2rem', flex: 1 }}>
                        ...
                        <div className="pEntry__content">
                            ...
                            <p>Имея возможность размещать рекламу, мы обеспечиваем бизнес-стратегию человека, разместившего объявление.<br/>Кроме того, некоторые рекламные объявления ограничены с целью<br/>улучшения качества контента и стабильной работы вики. (Мы стабильно работаем уже более 3 месяцев.)</p>
                            ...
                            <div className={styles.panelBody}>
                                <div style={{ display: 'flex' }}>
                                    ...
                                    <div style={{ minWidth: '200px' }}>
                                        <p>Часть доходов от рекламы, полученных от этого сервиса, надлежащим<br/> образом используется для покрытия расходов критики NMNGyuri и<a href="/special_wiki/maitetsu_bkmt">Комитета по искоренению MaitetsuNet</a><br/>Мы надеемся, что благодаря доходам от рекламы мы<br/> сможем сказать вам, что ваше использование способствует критике NMNGyuri & MaitetsuNet.<br/></p>
