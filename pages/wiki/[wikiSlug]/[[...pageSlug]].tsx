                        ...
                        <div className="article text-center">
                            ...
                            <div className={styles.noticeWikiRemoval} role='alert'>
                                <span className={styles.noticeWikiRemoval__icon}>
                                    <svg xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%', fill: 'currentColor', transform: 'translateX(-4%)' }} viewBox="0 0 640 640">
                            ...
                            <svg className={styles.noticeWikiRemoval__overlayIcon} style={{ width: '100%', height: '100%', fill: 'currentColor', transform: 'translateX(-4%)' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
